...
class VGG(nn.Module):
    ...
    def __init__(self, features, num_classes=20, init_weights=True):
        ...
        if init_weights:
            init.normal_(self.extra_conv1.weight, mean=0, std=0.01)
            init.normal_(self.extra_conv2.weight, mean=0, std=0.01)
            init.normal_(self.extra_conv3.weight, mean=0, std=0.01)
            init.normal_(self.extra_conv4.weight, mean=0, std=0.01)
